...
import {
  getServerActions,
  useServers,
} from "../../../stores/lobby/servers.store";
import React, { useEffect } from "react";
import {
  getChangeAccount,
  useAccount,
} from "../../../stores/lobby/account.store";
  ...
  return (
    <Paper>
      ...
      <List>
        ...
        <MenuItem onClick={() => changeType("lobby")}>Host / Join</MenuItem>
        <MenuItem onClick={() => changeType("mmo")}>MMO</MenuItem>
      </List>
    </Paper>
  );
};
